...
export function useAuth() {
  ...
  const register = async (phone: string, full_name: string, password: string, confirm_password: string) => {
    return API.post('/auth/register', { phone, full_name, password, confirm_password });
  };
